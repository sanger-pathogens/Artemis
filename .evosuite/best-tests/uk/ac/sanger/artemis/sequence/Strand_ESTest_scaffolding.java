...
public class Strand_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "uk.ac.sanger.artemis.sequence.Strand"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Strand_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.datatransfer.Clipboard", false, Strand_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.nio.CharBuffer", false, Strand_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("uk.ac.sanger.artemis.FeaturePredicate", false, Strand_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Strand_ESTest_scaffolding.class.getClassLoader()); 
