...
public class ContigTool_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ContigTool_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "uk.ac.sanger.artemis.components.ContigTool$6",
      "uk.ac.sanger.artemis.components.ContigTool$5",
      "uk.ac.sanger.artemis.io.IndexedGFFDocumentEntry$IndexContig",
      "uk.ac.sanger.artemis.components.ContigTool$4",
      "org.gmod.schema.sequence.Feature",
      "uk.ac.sanger.artemis.components.ContigTool$3",
      ...
      "uk.ac.sanger.artemis.components.ContigTool$2",
      "uk.ac.sanger.artemis.components.ContigTool$1",
