...
public class ChadoTransaction_ESTest extends ChadoTransaction_ESTest_scaffolding {
  ...
  public void test26()  throws Throwable  {
      ...
      Timestamp timestamp0 = new Timestamp(0L);
      ChadoTransaction chadoTransaction0 = new ChadoTransaction((-1298), minguoDate0, timestamp0, (GFFStreamFeature) null, "CDS", "CDS");
      assertEquals((-1298), chadoTransaction0.getType());
      assertEquals("CDS", chadoTransaction0.getFeatureKey());
  }
