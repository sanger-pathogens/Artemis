...
public class FeatureDbXRef_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gmod.schema.sequence.FeatureDbXRef"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FeatureDbXRef_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.gmod.schema.general.DbXRef", false, FeatureDbXRef_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.gmod.schema.sequence.Feature", false, FeatureDbXRef_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(FeatureDbXRef_ESTest_scaffolding.class.getClassLoader()); 
