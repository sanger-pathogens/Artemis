...
public class FeatureCvTermPub_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gmod.schema.sequence.FeatureCvTermPub"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FeatureCvTermPub_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.gmod.schema.pub.Pub", false, FeatureCvTermPub_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.gmod.schema.sequence.FeatureCvTerm", false, FeatureCvTermPub_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(FeatureCvTermPub_ESTest_scaffolding.class.getClassLoader()); 
