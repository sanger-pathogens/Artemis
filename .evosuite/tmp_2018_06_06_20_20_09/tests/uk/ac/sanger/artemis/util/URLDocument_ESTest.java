...
public class URLDocument_ESTest extends URLDocument_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      URL uRL0 = MockURL.getFileExample();
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL1 = MockURL.URL(uRL0, "LinePushBackReader.pushBack () called twice before calling readLine ()", uRLStreamHandler0);
      URLDocument uRLDocument0 = new URLDocument(uRL1);
      // Undeclared exception!
      try { 
  ...
  public void test04()  throws Throwable  {
      ...
      URLDocument uRLDocument0 = new URLDocument(uRL0);
      uRLDocument0.setLocation("/some_dir/some.jar");
      // Undeclared exception!
      try { 
        uRLDocument0.getName();
        fail("Expecting exception: ClassCastException");
  ...
  public void test08()  throws Throwable  {
      URLStreamHandler uRLStreamHandler0 = mock(URLStreamHandler.class, new ViolatedAssumptionAnswer());
      URL uRL0 = MockURL.URL("g", ",)iNPZE$1L9h/T", 0, "8U{", uRLStreamHandler0);
      URLDocument uRLDocument0 = new URLDocument(uRL0);
      try { 
        uRLDocument0.append("g");
  ...
  public void test10()  throws Throwable  {
      URL uRL0 = MockURL.getFtpExample();
      URLDocument uRLDocument0 = new URLDocument(uRL0);
      uRLDocument0.setLocation("_nNI]UvyPgv<J[");
      // Undeclared exception!
      try { 
        uRLDocument0.append("_nNI]UvyPgv<J[");
        fail("Expecting exception: ClassCastException");
  ...
  public void test12()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/this Document can not be written to");
      URL uRL0 = MockURL.getHttpExample();
      URL uRL1 = MockURL.URL(uRL0, "this Document can not be written to");
      URLDocument uRLDocument0 = new URLDocument(uRL1);
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "this Document can not be written to");
