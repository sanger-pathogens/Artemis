...
public class GCFrameAlgorithm_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.Graphics", false, GCFrameAlgorithm_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("uk.ac.sanger.artemis.plot.LineAttributes", false, GCFrameAlgorithm_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("uk.ac.sanger.artemis.sequence.Strand", false, GCFrameAlgorithm_ESTest_scaffolding.class.getClassLoader()));
  }
