...
public class Selector_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Selector_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "uk.ac.sanger.artemis.components.Selector$6",
      "uk.ac.sanger.artemis.components.Selector$7",
      "uk.ac.sanger.artemis.components.Selector$4",
      "uk.ac.sanger.artemis.components.Selector$5",
      "uk.ac.sanger.artemis.ChangeListener",
      "uk.ac.sanger.artemis.io.FeatureTree",
      "uk.ac.sanger.artemis.components.Selector$8",
      "uk.ac.sanger.artemis.ChangeEventVector",
      "uk.ac.sanger.artemis.components.Selector$9",
      "uk.ac.sanger.artemis.plot.LineAttributes",
      "org.apache.log4j.helpers.Loader",
      "uk.ac.sanger.artemis.components.Selector$2",
      "uk.ac.sanger.artemis.sequence.MarkerChangeEvent",
      "uk.ac.sanger.artemis.components.Selector$3",
      "org.biojava.utils.stax.SAX2StAXAdaptor$HandlerBinding",
      "uk.ac.sanger.artemis.components.Selector$1",
      ...
      "uk.ac.sanger.artemis.components.Selector$15",
      "uk.ac.sanger.artemis.ExternalProgramException",
      "uk.ac.sanger.artemis.io.QualifierVector",
      "uk.ac.sanger.artemis.components.Selector$16",
      ...
      "uk.ac.sanger.artemis.components.Selector$11",
      "uk.ac.sanger.artemis.components.Selector$12",
      "uk.ac.sanger.artemis.components.Selector$13",
      "uk.ac.sanger.artemis.components.Selector$14",
      "uk.ac.sanger.artemis.plot.CodonWeight",
      "org.biojava.bio.symbol.AlphabetManager$GapSymbol",
      "uk.ac.sanger.artemis.components.Selector$10",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.datatransfer.Clipboard", false, Selector_ESTest_scaffolding.class.getClassLoader()));
  }
