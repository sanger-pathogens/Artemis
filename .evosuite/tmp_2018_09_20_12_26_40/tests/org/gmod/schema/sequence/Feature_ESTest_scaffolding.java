...
public class Feature_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gmod.schema.sequence.Feature"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.sql.Timestamp", false, Feature_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.gmod.schema.cv.CvTerm", false, Feature_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.gmod.schema.organism.Organism", false, Feature_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.gmod.schema.sequence.FeatureProp", false, Feature_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.gmod.schema.sequence.FeatureRelationship", false, Feature_ESTest_scaffolding.class.getClassLoader()));
  }
