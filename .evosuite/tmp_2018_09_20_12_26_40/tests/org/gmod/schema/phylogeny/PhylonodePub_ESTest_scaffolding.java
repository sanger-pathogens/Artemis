...
public class PhylonodePub_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gmod.schema.phylogeny.PhylonodePub"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PhylonodePub_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.gmod.schema.phylogeny.Phylonode", false, PhylonodePub_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.gmod.schema.pub.Pub", false, PhylonodePub_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PhylonodePub_ESTest_scaffolding.class.getClassLoader()); 
