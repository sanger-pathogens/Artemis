...
public class DatabaseEntryFilterPanel_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "uk.ac.sanger.artemis.components.filetree.DatabaseEntryFilterPanel"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DatabaseEntryFilterPanel_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "uk.ac.sanger.artemis.components.filetree.DatabaseEntryFilterPanel",
      ...
      "uk.ac.sanger.artemis.components.filetree.DatabaseEntryFilterPanel$2",
      "org.gmod.schema.general.DbXRef",
      "uk.ac.sanger.artemis.io.Key",
      "uk.ac.sanger.artemis.io.PartialSequence",
      "uk.ac.sanger.artemis.components.filetree.DatabaseEntryFilterPanel$1",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DatabaseEntryFilterPanel_ESTest_scaffolding.class.getClassLoader()); 
