...
public class ScoreScrollbar_ESTest extends ScoreScrollbar_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ScoreScrollbar scoreScrollbar0 = new ScoreScrollbar(2183, 2183);
      ...
      AdjustmentEvent adjustmentEvent0 = new AdjustmentEvent(scoreScrollbar0, 2183, 2183, 2183);
      scoreScrollbar0.adjustmentValueChanged(adjustmentEvent0);
      assertEquals(2183, adjustmentEvent0.getValue());
  }
  ...
  public void test1()  throws Throwable  {
      ...
      try {
        scoreScrollbar0 = new ScoreScrollbar(1483, 1483, 0, 3320);
  ...
  public void test2()  throws Throwable  {
      ScoreScrollbar scoreScrollbar0 = new ScoreScrollbar(0, 44, 0, 0);
      ScoreChangeListener scoreChangeListener0 = mock(ScoreChangeListener.class, new ViolatedAssumptionAnswer());
  ...
  public void test3()  throws Throwable  {
      ScoreScrollbar scoreScrollbar0 = new ScoreScrollbar(15, 15);
  ...
  public void test4()  throws Throwable  {
      ScoreScrollbar scoreScrollbar0 = null;
      try {
        scoreScrollbar0 = new ScoreScrollbar(0, 0, 2632, 0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test5()  throws Throwable  {
      ScoreScrollbar scoreScrollbar0 = null;
      try {
        scoreScrollbar0 = new ScoreScrollbar(0, (-1572));
        fail("Expecting exception: IllegalArgumentException");
