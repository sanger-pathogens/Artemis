...
public class ReferenceSource_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "uk.ac.sanger.artemis.cramtools.ref.ReferenceSource"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ReferenceSource_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "uk.ac.sanger.artemis.cramtools.ref.ReferenceSource",
      ...
      "uk.ac.sanger.artemis.cramtools.ref.ReferenceRegion",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ReferenceSource_ESTest_scaffolding.class.getClassLoader()); 
