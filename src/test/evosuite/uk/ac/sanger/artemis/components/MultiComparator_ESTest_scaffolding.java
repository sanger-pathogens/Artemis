...
public class MultiComparator_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MultiComparator_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "uk.ac.sanger.artemis.components.MultiComparator$20",
      ...
      "uk.ac.sanger.artemis.components.MultiComparator$19",
      "uk.ac.sanger.artemis.components.MultiComparator$17",
      "uk.ac.sanger.artemis.components.MultiComparator$18",
      "uk.ac.sanger.artemis.circular.TextFieldInt",
      "uk.ac.sanger.artemis.components.MultiComparator$15",
      "uk.ac.sanger.artemis.components.MultiComparator$16",
      "uk.ac.sanger.artemis.components.MultiComparator$13",
      "uk.ac.sanger.artemis.components.MultiComparator$14",
      ...
      "uk.ac.sanger.artemis.components.MultiComparator$11",
      "uk.ac.sanger.artemis.components.MultiComparator$12",
      "uk.ac.sanger.artemis.components.MultiComparator$10",
      ...
      "uk.ac.sanger.artemis.components.MultiComparator$9",
      "net.sf.cglib.core.ClassEmitter",
      "uk.ac.sanger.artemis.components.Plot",
      "uk.ac.sanger.artemis.components.MultiComparator$8",
      "uk.ac.sanger.artemis.components.MultiComparator$7",
      "org.gmod.schema.sequence.FeatureCvTermDbXRef",
      "uk.ac.sanger.artemis.components.MultiComparator$6",
      "uk.ac.sanger.artemis.components.MultiComparator$5",
      ...
      "uk.ac.sanger.artemis.components.MultiComparator$3",
      "com.ibatis.sqlmap.engine.type.StringTypeHandler",
      "uk.ac.sanger.artemis.components.MultiComparator$2",
      "net.sf.cglib.core.ClassNameReader",
      "uk.ac.sanger.artemis.components.MultiComparator$1",
