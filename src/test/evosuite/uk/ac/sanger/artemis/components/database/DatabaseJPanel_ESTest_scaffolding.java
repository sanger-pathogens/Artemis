...
public class DatabaseJPanel_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DatabaseJPanel_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "uk.ac.sanger.artemis.components.database.DatabaseJPanel$2",
      "uk.ac.sanger.artemis.components.database.DatabaseJPanel$3",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("uk.ac.sanger.artemis.components.Splash", false, DatabaseJPanel_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("uk.ac.sanger.artemis.components.database.DatabaseEntrySource", false, DatabaseJPanel_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("uk.ac.sanger.artemis.util.InputStreamProgressListener", false, DatabaseJPanel_ESTest_scaffolding.class.getClassLoader()));
  }
