...
public class QualifierChoice_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("uk.ac.sanger.artemis.io.EntryInformation", false, QualifierChoice_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("uk.ac.sanger.artemis.io.Key", false, QualifierChoice_ESTest_scaffolding.class.getClassLoader()));
  }
