...
public class Navigator_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "uk.ac.sanger.artemis.components.Navigator"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Navigator_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "uk.ac.sanger.artemis.components.Navigator$1",
      "org.biojava.utils.ClassTools",
      "uk.ac.sanger.artemis.components.Navigator$5",
      "uk.ac.sanger.artemis.components.Navigator$4",
      "net.sf.cglib.core.Customizer",
      "uk.ac.sanger.artemis.components.Navigator$3",
      "uk.ac.sanger.artemis.io.EmblStreamFeature",
      "uk.ac.sanger.artemis.components.Navigator$2",
      "uk.ac.sanger.artemis.components.Navigator$9",
      "org.biojava.utils.cache.WeakValueHashMap",
      "uk.ac.sanger.artemis.components.Navigator$8",
      "uk.ac.sanger.artemis.ExternalProgramVector",
      "org.biojava.bio.symbol.IllegalSymbolException",
      "uk.ac.sanger.artemis.components.Navigator$7",
      "uk.ac.sanger.artemis.components.Navigator$6",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Navigator_ESTest_scaffolding.class.getClassLoader()); 
