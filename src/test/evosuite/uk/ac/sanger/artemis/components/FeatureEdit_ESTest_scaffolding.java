...
public class FeatureEdit_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "uk.ac.sanger.artemis.components.FeatureEdit"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FeatureEdit_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "uk.ac.sanger.artemis.components.FeatureEdit$3",
      "com.ibatis.sqlmap.engine.builder.xml.SqlMapConfigParser$11",
      "uk.ac.sanger.artemis.components.FeatureEdit$4",
      "com.ibatis.sqlmap.engine.builder.xml.SqlMapConfigParser$12",
      "uk.ac.sanger.artemis.components.FeatureEdit$1",
      "uk.ac.sanger.artemis.components.FeatureEdit$2",
      "uk.ac.sanger.artemis.components.FeatureEdit$7",
      "uk.ac.sanger.artemis.components.FeatureEdit$8",
      "org.biojava.utils.lsid.Identifiable",
      "org.biojava.bio.seq.io.CharacterTokenization$TPStreamParser",
      "uk.ac.sanger.artemis.components.FeatureEdit$5",
      "org.biojava.ontology.Variable",
      "uk.ac.sanger.artemis.components.FeatureEdit$6",
      "org.postgresql.largeobject.LargeObject",
      "net.sf.cglib.core.ClassGenerator",
      "uk.ac.sanger.artemis.components.FeatureEdit$9",
      ...
      "uk.ac.sanger.artemis.components.FeatureEdit$11$1",
      ...
      "uk.ac.sanger.artemis.components.FeatureEdit$10",
      "uk.ac.sanger.artemis.components.FeatureEdit$11",
      "uk.ac.sanger.artemis.components.FeatureEdit$12",
      "org.biojava.utils.ChangeSupport",
      "uk.ac.sanger.artemis.components.FeatureEdit$13",
      ...
      "uk.ac.sanger.artemis.components.FeatureEdit$14",
      "uk.ac.sanger.artemis.components.FeatureEdit$15",
      "uk.ac.sanger.artemis.io.Entry",
      "uk.ac.sanger.artemis.components.FeatureEdit$16",
      "uk.ac.sanger.artemis.util.LinePushBackReader",
      "uk.ac.sanger.artemis.components.FeatureEdit$17",
      "org.biojava.utils.ParseErrorSource",
      "uk.ac.sanger.artemis.components.FeatureEdit$18",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(FeatureEdit_ESTest_scaffolding.class.getClassLoader()); 
