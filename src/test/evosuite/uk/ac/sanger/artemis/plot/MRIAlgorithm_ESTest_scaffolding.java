...
public class MRIAlgorithm_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.Color", false, MRIAlgorithm_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.Graphics", false, MRIAlgorithm_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("uk.ac.sanger.artemis.sequence.Strand", false, MRIAlgorithm_ESTest_scaffolding.class.getClassLoader()));
  }
