...
public class FileSelectionPanel_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "uk.ac.sanger.artemis.circular.digest.FileSelectionPanel"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FileSelectionPanel_ESTest_scaffolding.class.getClassLoader() ,
      "htsjdk.variant.vcf.VCFHeaderLine",
      "htsjdk.variant.vcf.VCFHeader",
      "uk.ac.sanger.artemis.circular.digest.FileSelectionPanel$2",
      "htsjdk.tribble.TribbleException$InvalidHeader",
      "htsjdk.samtools.util.Log$LogLevel",
      "uk.ac.sanger.artemis.circular.digest.FileSelectionPanel",
      "uk.ac.sanger.artemis.circular.digest.FileSelectionPanel$1",
      "htsjdk.tribble.TribbleException",
      "uk.ac.sanger.artemis.circular.digest.FileSelectionPanel$SelectionRow",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(FileSelectionPanel_ESTest_scaffolding.class.getClassLoader()); 
