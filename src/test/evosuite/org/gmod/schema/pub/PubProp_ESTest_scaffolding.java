...
public class PubProp_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gmod.schema.pub.PubProp"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PubProp_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.gmod.schema.cv.CvTerm", false, PubProp_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.gmod.schema.pub.Pub", false, PubProp_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PubProp_ESTest_scaffolding.class.getClassLoader()); 
