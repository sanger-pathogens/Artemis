...
public class ConnectionIBatis
{
  public ConnectionIBatis()
  {
  }
   ...
   *
   */
  public static String getFeatureName(final int feature_id,
                               final String schema)
                       throws SQLException
  {
   ...
   *
   */
  public static List getGff(final int feature_id,
                     final String schema)
                     throws SQLException
  {
    SqlMapClient sqlMap = DbSqlConfig.getSqlMapInstance();
   ...
   *
   */
  public static Feature getSequence(final int feature_id,
                             final String schema)
                        throws SQLException
  {
    SqlMapClient sqlMap = DbSqlConfig.getSqlMapInstance();
   ...
   *
   */
  public static List getResidueFeatures(List cvterm_ids, 
                                 final String schema)
                     throws SQLException
  {
    SqlMapClient sqlMap = DbSqlConfig.getSqlMapInstance();
   ...
   *
   */
  public static List getResidueType(final String schema)
                     throws SQLException
  {
    SqlMapClient sqlMap = DbSqlConfig.getSqlMapInstance();
