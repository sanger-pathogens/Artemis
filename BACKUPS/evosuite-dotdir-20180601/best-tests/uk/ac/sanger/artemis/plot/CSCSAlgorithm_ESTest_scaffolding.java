...
public class CSCSAlgorithm_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "uk.ac.sanger.artemis.plot.CSCSAlgorithm"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CSCSAlgorithm_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.Color", false, CSCSAlgorithm_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.Graphics", false, CSCSAlgorithm_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("uk.ac.sanger.artemis.plot.LineAttributes", false, CSCSAlgorithm_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("uk.ac.sanger.artemis.sequence.Bases", false, CSCSAlgorithm_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("uk.ac.sanger.artemis.sequence.Strand", false, CSCSAlgorithm_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CSCSAlgorithm_ESTest_scaffolding.class.getClassLoader()); 
