...
public class FeaturePopup_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FeaturePopup_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "uk.ac.sanger.artemis.components.FeaturePopup$20",
      "uk.ac.sanger.artemis.components.FeaturePopup$23",
      "org.emboss.jemboss.gui.Browser$3",
      "uk.ac.sanger.artemis.components.FeaturePopup$24",
      "org.emboss.jemboss.gui.Browser$4",
      "uk.ac.sanger.artemis.components.FeaturePopup$21",
      "uk.ac.sanger.artemis.components.FeaturePopup$22",
      "uk.ac.sanger.artemis.components.FeaturePopup$27",
      "org.postgresql.util.WriterHandler",
      "uk.ac.sanger.artemis.components.FeaturePopup$28",
      "uk.ac.sanger.artemis.components.FeaturePopup$25",
      "uk.ac.sanger.artemis.plot.GCFrameAlgorithm",
      "uk.ac.sanger.artemis.components.FeaturePopup$26",
      "net.sf.cglib.asm.MethodWriter",
      "org.emboss.jemboss.gui.Browser$6",
      "uk.ac.sanger.artemis.io.QualifierInfoHash",
      "uk.ac.sanger.artemis.components.FeaturePopup$29",
      ...
      "uk.ac.sanger.artemis.components.FeaturePopup$12",
      "uk.ac.sanger.artemis.components.FeaturePopup$13",
      "uk.ac.sanger.artemis.components.FeaturePopup$10",
      "uk.ac.sanger.artemis.components.FeaturePopup$11",
      "uk.ac.sanger.artemis.components.FeaturePopup$16",
      "net.sf.cglib.core.AbstractClassGenerator$1",
      "uk.ac.sanger.artemis.components.FeaturePopup$17",
      "com.sshtools.ssh.SshIO",
      "uk.ac.sanger.artemis.components.FeaturePopup$14",
      "uk.ac.sanger.artemis.components.FeaturePopup$15",
      ...
      "uk.ac.sanger.artemis.components.FeaturePopup$18",
      "uk.ac.sanger.artemis.components.FeaturePopup$19",
      ...
      "uk.ac.sanger.artemis.components.FeaturePopup$30",
      ...
      "uk.ac.sanger.artemis.components.FeaturePopup$9",
      "uk.ac.sanger.artemis.AlignMatch",
      "uk.ac.sanger.artemis.components.FeaturePopup$7",
      "uk.ac.sanger.artemis.components.FeaturePopup$8",
      "uk.ac.sanger.artemis.io.FeatureVector",
      "uk.ac.sanger.artemis.chado.ChadoTransactionManager",
      "uk.ac.sanger.artemis.components.FeaturePopup$5",
      "org.biojava.bio.symbol.LinearAlphabetIndex",
      "uk.ac.sanger.artemis.components.FeaturePopup$6",
      ...
      "uk.ac.sanger.artemis.components.FeaturePopup$3",
      "uk.ac.sanger.artemis.components.FeaturePopup$4",
      "uk.ac.sanger.artemis.SelectionChangeListener",
      "uk.ac.sanger.artemis.components.FeaturePopup$1",
      "uk.ac.sanger.artemis.components.FeaturePopup$2"
    );
  } 
