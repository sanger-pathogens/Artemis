...
public class FileList_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.File", false, FileList_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("uk.ac.sanger.artemis.j2ssh.FTProgress", false, FileList_ESTest_scaffolding.class.getClassLoader()));
  }
