...
public class DatabaseJTree_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("uk.ac.sanger.artemis.components.database.DatabaseTreeNode", false, DatabaseJTree_ESTest_scaffolding.class.getClassLoader()));
  }
  ...
  private static void resetClasses() {
    ...
    org.evosuite.runtime.classhandling.ClassStateSupport.resetClasses(
      "uk.ac.sanger.artemis.components.database.DatabaseJTree",
      "uk.ac.sanger.artemis.components.database.DatabaseJTree$1",
      "uk.ac.sanger.artemis.components.database.DatabaseTreeNode",
      "uk.ac.sanger.artemis.util.Document",
