...
public class Selection_ESTest extends Selection_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Clipboard clipboard0 = new Clipboard("]7E^_uHBOdzJ&=");
      Selection selection0 = new Selection(clipboard0);
      // Undeclared exception!
      try { 
  ...
  public void test04()  throws Throwable  {
      Clipboard clipboard0 = new Clipboard("V3L1q22wmG7");
      Selection selection0 = new Selection(clipboard0);
  ...
  public void test06()  throws Throwable  {
      Clipboard clipboard0 = new Clipboard(", for input source: ");
      Selection selection0 = new Selection(clipboard0);
      // Undeclared exception!
      try { 
  ...
  public void test09()  throws Throwable  {
      Clipboard clipboard0 = new Clipboard("(vH`](\"3N>mZ");
      Selection selection0 = new Selection(clipboard0);
      // Undeclared exception!
      try { 
  ...
  public void test11()  throws Throwable  {
      Clipboard clipboard0 = new Clipboard("H)S6Q");
      Selection selection0 = new Selection(clipboard0);
  ...
  public void test13()  throws Throwable  {
      Clipboard clipboard0 = new Clipboard("s(");
      Selection selection0 = new Selection(clipboard0);
  ...
  public void test15()  throws Throwable  {
      Clipboard clipboard0 = new Clipboard("E?i7hemPLI;Ce04");
      Selection selection0 = new Selection(clipboard0);
  ...
  public void test23()  throws Throwable  {
      Clipboard clipboard0 = new Clipboard("internal error - too many exceptions: ");
      Selection selection0 = new Selection(clipboard0);
  ...
  public void test29()  throws Throwable  {
      Clipboard clipboard0 = new Clipboard("IllegalSymbolException binding mapping for ");
      Selection selection0 = new Selection(clipboard0);
      EntryChangeEvent entryChangeEvent0 = new EntryChangeEvent(selection0, (Entry) null, (-1931));
  ...
  public void test30()  throws Throwable  {
      Clipboard clipboard0 = new Clipboard("internal error - unexpected exception: ");
      Selection selection0 = new Selection(clipboard0);
      // Undeclared exception!
      try { 
  ...
  public void test34()  throws Throwable  {
      Clipboard clipboard0 = new Clipboard("[^+{OD8/");
      Selection selection0 = new Selection(clipboard0);
      FeatureVector featureVector0 = new FeatureVector();
  ...
  public void test36()  throws Throwable  {
      Clipboard clipboard0 = new Clipboard("H)S6Q");
      StringSelection stringSelection0 = new StringSelection("H)S6Q");
      Selection selection0 = new Selection(clipboard0);
      selection0.lostOwnership(clipboard0, stringSelection0);
      assertEquals("H)S6Q", clipboard0.getName());
  }
  ...
  public void test38()  throws Throwable  {
      Clipboard clipboard0 = new Clipboard("T'@9Ix$/M#;4KBi");
      Selection selection0 = new Selection(clipboard0);
