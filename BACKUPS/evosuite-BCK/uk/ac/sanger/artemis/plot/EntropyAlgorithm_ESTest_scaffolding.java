...
public class EntropyAlgorithm_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.Graphics", false, EntropyAlgorithm_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("uk.ac.sanger.artemis.plot.LineAttributes", false, EntropyAlgorithm_ESTest_scaffolding.class.getClassLoader()));
