...
public class ReadGroupsFrame_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "uk.ac.sanger.artemis.components.alignment.ReadGroupsFrame"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ReadGroupsFrame_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("uk.ac.sanger.artemis.components.alignment.BamView", false, ReadGroupsFrame_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ReadGroupsFrame_ESTest_scaffolding.class.getClassLoader()); 

    org.evosuite.runtime.classhandling.ClassStateSupport.resetClasses(
      "uk.ac.sanger.artemis.components.alignment.ReadGroupsFrame",
      "uk.ac.sanger.artemis.components.alignment.ReadGroupsFrame$1",
      "uk.ac.sanger.artemis.components.alignment.ReadGroupsFrame$2",
      "uk.ac.sanger.artemis.components.alignment.ReadGroupsFrame$3",
      "uk.ac.sanger.artemis.components.alignment.ReadGroupsFrame$4",
