...
public class KeyChoice_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.event.ItemListener", false, KeyChoice_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("uk.ac.sanger.artemis.io.EntryInformation", false, KeyChoice_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("uk.ac.sanger.artemis.io.Key", false, KeyChoice_ESTest_scaffolding.class.getClassLoader()));
  }
