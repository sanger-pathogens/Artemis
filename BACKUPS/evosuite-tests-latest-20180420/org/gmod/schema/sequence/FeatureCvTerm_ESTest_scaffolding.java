...
public class FeatureCvTerm_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gmod.schema.sequence.FeatureCvTerm"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FeatureCvTerm_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.gmod.schema.cv.CvTerm", false, FeatureCvTerm_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.gmod.schema.pub.Pub", false, FeatureCvTerm_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.gmod.schema.sequence.Feature", false, FeatureCvTerm_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(FeatureCvTerm_ESTest_scaffolding.class.getClassLoader()); 
