...
public class PhylotreePub_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gmod.schema.phylogeny.PhylotreePub"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PhylotreePub_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.gmod.schema.phylogeny.Phylotree", false, PhylotreePub_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.gmod.schema.pub.Pub", false, PhylotreePub_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PhylotreePub_ESTest_scaffolding.class.getClassLoader()); 
