...
__Note__: For additional information please see the [ACT manual](ftp://ftp.sanger.ac.uk/pub/resources/software/artemis/act.pdf) and our [GitHub page](https://github.com/sanger-pathogens/Artemis/).
